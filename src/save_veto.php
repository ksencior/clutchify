...
function prepareMatch($map) {
    ...
    register_shutdown_function(function() {
        ...
        include './rcon_connect.php';
        $rcon->sendCommand('matchzy_loadmatch_url "https://zsnturniej.0bg.pl/src/tmp/matchzy_config.json"');
        $rcon->sendCommand('matchzy_remote_log_url "https://zsnturniej.0bg.pl/src/matchzy_events.php"');
    });
}
